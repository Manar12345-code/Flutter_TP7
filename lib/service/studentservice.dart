...
Future getAllStudent() async {
  Response response =
      await http.get(Uri.parse("http://192.168.158.97:8081/etudiant/all"));
  return jsonDecode(response.body);
}

Future deleteStudent(int id) {
  return http
      .delete(Uri.parse("http://192.168.158.97:8081/etudiant/delete?id=${id}"));
}

Future addStudent(Student student) async {
  print(student.dateNais);
  Response response =
      await http.post(Uri.parse("http://192.168.158.97:8081/etudiant/add"),
...
Future updateStudent(Student student) async {
  Response response =
      await http.put(Uri.parse("http://192.168.158.97:8081/etudiant/update"),
          headers: {"Content-type": "Application/json"},
